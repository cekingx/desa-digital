	...
	<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
		...
		<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
			...
			<ul class="menu-nav">
				...
				<li class="menu-item menu-item-submenu <?php if ($this->uri->segment(1) == "super" && $this->uri->segment(2) == "manajemen-pengguna") : ?> menu-item-open menu-item-here <?php endif ?>" aria-haspopup="true" data-menu-toggle="hover">
					<a href="javascript:;" class="menu-link menu-toggle">
						<span class="svg-icon menu-icon">
							<!--begin::Svg Icon | path:/metronic/theme/html/demo1/dist/assets/media/svg/icons/Layout/Layout-4-blocks.svg-->
							<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
					...
					<div class="menu-submenu">
						...
						<ul class="menu-subnav">
							...
							<li class="menu-item <?php if ($this->uri->segment(1) == "super" && $this->uri->segment(2) == "manajemen-pengguna" && $this->uri->segment(3) == "ubah-password") : ?>menu-item-active<?php endif ?>" aria-haspopup="true">
								<a href="<?php echo base_url('super/manajemen-pengguna/ubah-password') ?>" class="menu-link">
									<i class="menu-bullet menu-bullet-dot">
										<span></span>
									</i>
