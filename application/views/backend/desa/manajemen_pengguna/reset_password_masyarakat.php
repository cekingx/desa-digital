                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-6">
                                <input type="text" class="form-control form-control-lg form-control-solid"
                                    id="user_username" value="<?= $user->user_username ?>" disabled/>
                            </div>
                        </div>
                    </div>
...
<script>
        ...
        bootbox.confirm({
            ...
            callback: function (result) {
                ...
                if(result) {
                    ...
                    $.ajax({
                        // url: '<?= base_url('debug') ?>',
                        url: '<?= base_url('desa/manajemen-pengguna/reset-password/store') ?>',
                        type: 'POST',
                        data: data,
                        contentType: false,
                        processData: false,
    ...
    $('#cancel_button').click(function() {
        window.location = '<?= base_url('desa/manajemen-pengguna/masyarakat') ?>'
    })
</script>