...
<script>
    ...
    var KTDatatablePengumuman = function () {
        var demo = function() {
            ...
            $(document).on("click", ".btnEdit", function() {
                ...
                // console.log("<?= base_url('desa/galeri/edit/') ?>" + id)
                window.location.replace("<?= base_url('desa/galeri/edit/') ?>" + id);
            });
        }
    ...
    $('.btnNew').click(function() {
        window.location = '<?= base_url('desa/galeri/create') ?>'
    })
</script>
