    ...
    var KTDatatablePengumuman = function () {
        var demo = function() {
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        template: function(row) {
                            return '\
                                <button data-id="'+row.banjar_id+'" class="btn btn-sm btn-clean btn-icon mr-2 btnEdit" title="Edit details">\
                                    <span class="svg-icon svg-icon-md">\
                                ...
                                <button data-id="'+row.banjar_id+'" class="btn btn-sm btn-clean btn-icon btnDelete" title="Delete">\
                                    <span class="svg-icon svg-icon-md">\
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">\
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">\
                                                <rect x="0" y="0" width="24" height="24"/>\
            ...
            $(document).on("click", ".btnDelete", function() {
                ...
                bootbox.confirm({
                    title: "Hapus Banjar",
                    message: "Apakah anda yakin menghapus banjar?",
                    buttons: {
                        cancel: {
                            label: "Batal"
                        },
