	                        ...
	                        <div class="col-xl-12 col-xxl-7">
	                            ...
	                            <form class="form" id="kt_form">
	                                ...
	                                <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                                        ...
                                        <div class="form-group">
                                            <label for="nomor_penduduk">Nomor Penduduk</label>
                                            <input 
                                                type="text" 
                                                class="form-control" 
                                                name="nomor_penduduk" 
	                                ...
	                                <div class="pb-5" data-wizard-type="step-content">
                                        ...
                                        <!-- begin::nomor-akta-perceraian -->
                                        <div class="form-group">
                                            <label for="nomor_akta_perceraian">Nomor Akta Perceraian</label>
                                            <input 
                                                type="text" 
                                                class="form-control" 
			...
			_formEl,
			{
				fields: {
                    ...
                    gelar: {
                        validators: {
                            notEmpty: {
                                message: 'Gelar tidak boleh kosong'
                            }
                        }
                    },
                    nomor_penduduk: {
                        validators: {
                            notEmpty: {
                                message: 'Nomor penduduk tidak boleh kosong'
                            }
                        }
                    },
                    alamat_sebelumnya: {
                    ...
                    kepemilikan_kelainan: {
                        validators: {
                            notEmpty: {
                                message: 'Kepemilikan kelainan tidak boleh kosong'
                            }
                        }
                    },
                    penyandang_cacat: {
                        validators: {
                            notEmpty: {
                                message: 'Penyandang cacat tidak boleh kosong'
                            }
                        }
                    },
				},
			...
			_formEl,
			{
				fields: {
                    ...
                    nik_ibu: {
                        validators: {
                            notEmpty: {
                                message: 'NIK ibu tidak boleh kosong'
                            }
                        }
                    },
                    nama_lengkap_ibu: {
                        validators: {
                            notEmpty: {
                                message: 'Nama lengkap ibu tidak boleh kosong'
                            }
                        }
                    },
                    nik_ayah: {
                        validators: {
                            notEmpty: {
                                message: 'NIK ayah tidak boleh kosong'
                            }
                        }
                    },
                    nama_lengkap_ayah: {
                        validators: {
                            notEmpty: {
                                message: 'Nama lengkap ayah tidak boleh kosong'
                            }
                        }
                    }
				},
