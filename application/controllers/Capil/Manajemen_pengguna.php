...
class Manajemen_pengguna extends CI_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('Capil/Manajemen_pengguna_model', 'manajemen_pengguna_model');
    ...
    public function ubah_password()
    {
        ...
        $data['content']        = 'backend/capil/manajemen_pengguna/ubah_password';
        $data['breadcrumbs']    = array(
            ...
            array(
                'url'   => 'capil/manajemen-pengguna/ubah-password',
                'title' => 'Ubah Password'
            )
        );
